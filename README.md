...
Description
This program creates a text file named sample.txt, writes a few lines into it, and then reads and prints its content line by line. If the file does not exist, it displays an appropriate error message.
...
Enter text to be written into a file named output.txt.
Enter additional text to be appended to the same file.
